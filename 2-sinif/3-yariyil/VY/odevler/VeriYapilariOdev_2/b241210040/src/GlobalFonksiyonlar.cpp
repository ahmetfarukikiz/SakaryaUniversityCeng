...
* @description daha öncesinde kendi yazdığım fonksiyonlar
...
//kullanıcıdan sayı isterken istenmeyen girişleri kontrol ediyorum. 
float kullanicidanSayiAl(bool tamSayiMi,int sinir) { 
